...
#define CUSTOM_NAME "Chet"  // This is only used if Auto_name is set to be 0
...
// Other sensors
#define is_max31856        1 // MAX31856 Thermocouple
...
#if is_relay == 1
  #define relay_pin 9  // Digital pin connected to the relay enable 
#endif
...
// --- PushingBox Options ---
  ...
  #warning "Cannot use google sheets without wifi enabled in config.h!"
  #define is_googlesheets 0
#endif
